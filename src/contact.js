...
const Contact = () => {
  const { loginWithRedirect, logout, user, isAuthenticated } = useAuth0();
    ...
    const senddata = async (e) =>
    {
        ...
        const res = fetch('https://e-commerce-contact-1dcf7-default-rtdb.firebaseio.com/Message.json', options)
        console.log(res)
        if (res)
        {
    ...
    <>
      <div className='contact_container'>
        <div className='contact'>
            ...
            <div className='form'>
                <form method='POST'>
                    <input type='text' name='Name' value={users.Name} placeholder='Enter Your Full' autoComplete='off' onChange={data}></input>
