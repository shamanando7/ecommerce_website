...
const Home = ({ detail, view, close, setClose, addtocart }) => {
    const [homeproducts, setHomeProduct] = useState(Homeproduct)
    return (
        <>
            {
                close ?
            ...
            <div className='top_banner'>
                <div className='container'>
                    ...
                    <div className='img_box'>
                        <img src='./img/slider-img.png' alt='slideimg'></img>
                    </div>
                </div>
            </div>
            <div className='product_type'>
                <div className='container'>
                    <div className='box'>
                        <div className='img_box'>
                            <img src='./img/mobile phone.webp' alt='mobile'></img>
                        </div>
                        <div className='detail'>
                            <p>23 products</p>
                        </div>
                    ...
                    <div className='box'>
                        <div className='img_box'>
                            <img src='./img/smart_watch.webp' alt='mobile'></img>
                        </div>
                        <div className='detail'>
                            <p>18 products</p>
                        </div>
                    ...
                    <div className='box'>
                        <div className='img_box'>
                            <img src='./img/cpu heat.jpg' alt='mobile'></img>
                        </div>
                        <div className='detail'>
                            <p>63 products</p>
                        </div>
